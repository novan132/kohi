...
/**
 * Register to listen for when events are sent wiht the provided code. Events with duplicate
...
/**
 * Unregister from listening for when events are sent wiht the provided code. If no matching
...
// System internal event codes. Application should use code beyond 255.
